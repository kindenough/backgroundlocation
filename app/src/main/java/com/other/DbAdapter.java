...
import com.amap.androidobackgroundlocation.MainActivity;
...
public class DbAdapter {
	...
	private static final String RECORD_TABLE2 = "record";
	private static final String RECORD_TABLE = "sms";
	private static final String RECORD_CREATE2 = "create table if not exists record("
			+ KEY_ROWID
			...
			+ "averagespeed STRING,"
			+ "date STRING" + ");";
	private static final String RECORD_CREATE = "create table if not exists sms("
			+ KEY_ROWID
			+ " integer primary key autoincrement,"
			+ "name STRING,"
			+ "tel STRING,"
